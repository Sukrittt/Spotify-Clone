...
const Loading = () => {
  return (
    <div className="h-full w-full overflow-hidden overflow-y-auto rounded-lg bg-neutral-900">
      <HeaderSkeleton className="from-neutral-600">
        <div className="mt-20">
          <div className="flex flex-col items-center gap-x-5 md:flex-row">
            ...
            <div className="flex flex-col gap-y-7">
              <div className="mt-4 flex flex-col gap-y-4 md:mt-0">
              ...
              <div className="flex gap-x-1">
                <Skeleton className="hidden h-4 w-[60px] bg-gray-600 md:block"></Skeleton>
                <Skeleton className="hidden h-4 w-[100px] bg-gray-600 md:block"></Skeleton>
              </div>
            </div>
          </div>
          <Skeleton className="my-6 h-8 w-8 rounded-full bg-gray-600"></Skeleton>
        </div>
      </HeaderSkeleton>
